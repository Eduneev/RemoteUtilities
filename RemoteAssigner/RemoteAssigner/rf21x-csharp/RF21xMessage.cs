...
public class RF21xMessage : IDisposable {
  private HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal RF21xMessage(IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new HandleRef(this, cPtr);
  }

  internal static HandleRef getCPtr(RF21xMessage obj) {
  ...
  public RF21xMessageRawData rawData {
    ...
    get {
      IntPtr cPtr = rf21xPINVOKE.RF21xMessage_rawData_get(swigCPtr);
      RF21xMessageRawData ret = (cPtr == IntPtr.Zero) ? null : new RF21xMessageRawData(cPtr, false);
      return ret;
    } 
  }
